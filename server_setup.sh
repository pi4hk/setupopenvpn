...
ssh openvpn@${IP_ADDR} 'sed -i "s/my-server-1 1194/'"${IP_ADDR}"' 443/g" ~/client-configs/base.conf && sed -i "s/proto udp/proto tcp/g" ~/client-configs/base.conf && sed -i "s/;user nobody/user nobody/g" ~/client-configs/base.conf && sed -i "s/;group nogroup/group nogroup/g" ~/client-configs/base.conf && sed -i "s/ca ca.crt/#ca ca.crt/g" ~/client-configs/base.conf && sed -i "s/cert client.crt/#cert client.crt/g" ~/client-configs/base.conf && sed -i "s/cert client.key/#cert client.key/g" ~/client-configs/base.conf && sed -i "s/tls-auth ta.key 1/#tls-auth ta.key 1/g" ~/client-configs/base.conf'
